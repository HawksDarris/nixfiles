...
in {
  ...
  # TODO Modularize
  # colorScheme = {
  #   slug = "dracula"; # This is apparently necessary for gtk things but I don't know what it means or how to use it with custom themes.
...
# Reference example for specialization
